...
void Shader::init2(const std::string& vertFile, const std::string& fragFile, const std::string& geomFile)
{
	...
	{
		glAttachShader(program, shaders[i]); //Add all shaders to the shader program "shaders" 
	}
